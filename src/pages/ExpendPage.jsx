...
const ProductList = () => {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const response = await axios.get('https://inventory-app-theta-two.vercel.app/api/expend');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://inventory-app-theta-two.vercel.app/api/expend/${id}`);
      fetchProducts();
    } catch (err) {
