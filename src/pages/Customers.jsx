  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentCustomer) {
        ...
        await axios.put(`https://inventory-app-theta-two.vercel.app/api/customers/${currentCustomer._id}`, formData, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
        });
        toast.success('Клиент успешно обновлен');
      } else {
        // Создание нового клиента
        await axios.post('https://inventory-app-theta-two.vercel.app/api/customers', formData, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
        });
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
              <div className="flex justify-between items-center border-b px-6 py-4">
                <h3 className="text-lg font-medium">
                  {currentCustomer ? 'Редактировать клиента' : 'Добавить нового клиента'}
                </h3>
              ...
              <form onSubmit={handleSubmit} className="p-6">
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 mb-1">Кредитный лимит ($)</label>
                  <input
                    type="number"
                    name="creditLimit"
