...
const SalaryPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const selectedEmployee = employees.find(emp => emp._id === formData.employee.id);
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <h1 className="text-2xl font-bold text-gray-800">Управление зарплатами</h1>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Базовая зарплата</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Бонусы</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Удержания</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Итого к выплате</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">To'lov sanasi</th>
                    ...
                    <tr key={salary._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="font-medium">{(salary.employee.firstName)}</div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {new Date(salary.paymentDate).toLocaleDateString('uz-UZ')}
                      </td>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div className="flex justify-between items-center border-b px-6 py-4">
              <h3 className="text-lg font-medium">
                {currentSalary ? 'Редактировать зарплату' : 'Добавить новую зарплату'}
              </h3>
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Базовая зарплата ($)</label>
                  <input
                    type="number"
                    name="amount"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Дата выплаты</label>
                  <input
                    type="date"
                    name="paymentDate"
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Бонусы ($)</label>
                  <input
                    type="number"
                    name="bonus"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Удержания ($)</label>
                  <input
                    type="number"
                    name="deductions"
              ...
              <div className="flex justify-end gap-3">
                ...
                >
                  {isProcessing ? (
                    ...
                    currentSalary ? 'Сохранить изменения' : 'Добавить зарплату'
                  )}
                </button>
              </div>
            </form>
